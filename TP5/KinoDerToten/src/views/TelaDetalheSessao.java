...
/**
 * Classe <b>TelaDetalheSessao</b> só é acessada através da classe <b>TelaSessao</b>.
 * Dependendo se o usuário clicou em editar ou adicionar uma nova Sessao.
...
public class TelaDetalheSessao implements ActionListener{
	...
	/**
	 * O método <b>criaSessao</b> serve tanto para adicionar uma sessao nova ao sistema quanto para editar uma já existente.
	...
	/**
	 * O método <b>exibeSessao</b> é um JFrame com JLabels que mostram os detalhes de uma sessao já cadastrada.
	 * Caso o usuário queira editar algum desses detalhes, há uma opcão de editar, que leva o usuário ao método <b>criaSessao</b>
	 * @param d -> recebe instancia de controleDados
	...
	/**
	 * Esse método tem como único intuito preencher uma ComboBox para o método <b>criaSessao</b>
	 */

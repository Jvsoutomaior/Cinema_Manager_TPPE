...
public class TelaFilme implements ActionListener, ListSelectionListener{
	...
	/**
	 * O construtor da Classe <b>TelaFilme</b>. Aqui temos um JFrame com a lista de Filmes cadastrados, com a opção de editá-los ou adicionar um novo.

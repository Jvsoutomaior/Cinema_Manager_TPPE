...
/**
 * Classe <b>TelaDetalheFilme</b> só é acessada através da classe <b>TelaFilme</b>.
 * Dependendo se o usuário clicou em editar ou adicionar um novo Filme.
...
public class TelaDetalheFilme implements ActionListener{
	...
	/**
	 * O método <b>adicionaFilme</b> serve tanto para adicionar um filme novo ao sistema quanto para editar um já existente.
	 * Aqui tem vários compontentes do JSwing para o usuário entrar com dados.
	 * @param op -> indica qual caminho tomar (edição de existente ou adição de novo)
	...
	/**
	 * O método <b>exibeFilme</b> é um JFrame com JLabels que mostram os detalhes de um Filme já cadastrado.
	 * Caso o usuário queira editar algum desses detalhes, há uma opcão de editar, que leva o usuário ao método <b>adicionaFilme</b>
	...
	/**
	 * Esse método tem como único intuito preencher uma ComboBox para o método <b>adicionaFilme</b>
	 */
	...
	/**
	 * O método <b>retornaValueComboBox</b> serve para transformar o valor recebido da combobox em uma String, e enviá-lo para o método <b>inserirEditarFilme</b>.
	...
	/**
	 * Passa ao usuário um feedback positivo
	 */
	...
	/**
	 * Passa ao usuário um feedback negativo
	 */

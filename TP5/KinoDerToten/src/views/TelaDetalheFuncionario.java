...
/**
 * Classe <b>TelaDetalheFuncionario</b> só é acessada através da classe <b>TelaFuncionario</b>.
 * Dependendo se o usuário clicou em editar ou adicionar um novo Funcionario.
...
public class TelaDetalheFuncionario implements ActionListener{
	...
	/**
	 * O método <b>adicionaFuncionario</b> serve tanto para adicionar um funcionario novo ao sistema quanto para editar um já existente.
	...
	/**
	 * O método <b>exibeFuncionario</b> é um JFrame com JLabels que mostram os detalhes de um funcionario já cadastrado.
	 * Caso o usuário queira editar algum desses detalhes, há uma opcão de editar, que leva o usuário ao método <b>adicionaFuncionario</b>
	 * @param d -> recebe instancia de ControleDados
	...
	/**
	 * Passa ao usuário um feedback negatibo
	 */
	...
	/**
	 * Esse método tem como único intuito preencher uma ComboBox para o método <b>adicionaFuncionario</b>
	 */

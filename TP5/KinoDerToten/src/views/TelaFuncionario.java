...
public class TelaFuncionario implements ActionListener, ListSelectionListener{
	...
	/**
	 * O Construtor da classe <b>TelaFuncionario</b>. Aqui temos um JFrame com a lista de funcionários cadastrados, com a opção de editá-los ou contratar um novo.
	 * Também há um JTextField para pesquisa de funcionários a partir da lista.
	 * @param d -> recebe ControleDados
	 */
	...
	/**
	 * O Método <b>getListaFromSearch</b> compara os nomes dos funcionários com o nome pesquisado no <i>JTextField pesquisa</i>. Ele retorna uma lista de Nomes iguais ao da
	 * pesquisa
	 * @return array de nomes correspondentes à pesquisa.
	 */

...
/**
 * Classe <b>TelaDetalheUnidade</b> só é acessada através da classe <b>TelaUnidade</b>.
 * Dependendo se o usuário clicou em editar ou adicionar uma nova Unidade.
...
public class TelaDetalheUnidade implements ActionListener{
	...
	/**
	 * O método <b>adicionaUnidade</b> serve tanto para adicionar uma Unidade novo ao sistema quanto para editar uma já existente.
	 * Aqui tem vários compontentes do JSwing para o usuário entrar com dados.
	 * @param op -> indica qual caminho seguir (cirar novo ou editar existente)
	...
	/**
	 * O método <b>exibeUnidade</b> é um JFrame com JLabels que mostram os detalhes de uma unidade já cadastrada.
	 * Caso o usuário queira editar algum desses detalhes, há uma opcão de editar, que leva o usuário ao método <b>adicionaUnidade</b>
	 * @param d ->  recebe instancia de controleDados
	 * @param pos -> indica a posicao selecionada no index da JList
	 */

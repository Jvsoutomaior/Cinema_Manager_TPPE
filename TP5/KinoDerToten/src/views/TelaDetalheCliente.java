...
/**
 * Classe <b>TelaDetalheCliente</b> só é acessada através da classe <b>Tela Cliente</b>.
 * Dependendo se o usuário clicou em editar ou adicionar um novo cliente.
...
public class TelaDetalheCliente implements ActionListener{
	...
	/**
	 * O método <b>adicionaCliente</b> serve tanto para adicionar um cliente novo ao sistema quanto para editar um já existente.
	...
	/**
	 * O método <b>exibeCliente</b> é um JFrame com JLabels que mostram os detalhes de um cliente já cadastrado.
	 * Caso o usuário queira editar algum desses detalhes, há uma opcão de editar, que leva o usuário ao método <b>adicionaCliente</b>
	 * @param d -> recebe instancia de ControleDados
	 * @param pos -> recebe a posicao selecionada no JList
	 */
	...
	/**
	 * Esse método tem como único intuito preencher uma ComboBox para o método <b>adicionaCliente</b>
	 */
